...
¿Qué encontrar en este repositorio?
  ...
  - Manipulación de base de datos para productos, usuarios y pedidos (inyección + extracto de SQL)
  - Implementación de web puerta trasera (PHP)
  - Simulación del MVC (Servlets, Javabeans, JSPs, Javascript)
  - Web responsive y estilizada (CSS + Bootstrap)
...
What to find in this repository? 
  ...
  - Database manipulation for products, users and orders (injection + SQL extract)
  - Backdoor Web Implementation (PHP)
  - MVC simulation (Servlets, Javabeans, JSPs, Javascript)
  - Responsive and stylized website (CSS + Bootstrap)

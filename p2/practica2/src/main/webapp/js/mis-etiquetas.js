...
class Pie extends HTMLElement {
    constructor() {
        ...
        this.innerHTML = ` <footer >
                        ...
                        <a href="https://www.instagram.com/mariajo_arts/" target="_blank" rel="noopener noreferrer">
...
class Menu extends HTMLElement {
  ...
  <div class="container-fluid m-0 py-0">
      ...
      <ul class="navbar-nav ms-auto p-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="loginUsuario.jsp">Inicio sesion</a></li>
            <li><a class="dropdown-item" href="registro.jsp">Registro</a></li>
            <li><a class="dropdown-item" href="usuario.jsp">Perfil</a></li>
          </ul>
        </li>
      </ul>
    </div>
